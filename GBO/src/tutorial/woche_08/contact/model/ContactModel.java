package tutorial.woche_08.contact.model;
...
public class ContactModel
{
    ...
    private void createSampleData()
    {
        ...
        createContact("David", "B�chel", "buecheld@hochschule-trier.de");
        ...
        createContact("Karl-Stefan", "F�rst", "fuerstk@hochschule-trier.de");
        ...
        createContact("Marcel", "Gei�ler", "geisslm@hochschule-trier.de");
        createContact("Tobias", "Gepp", "geppt@hochschule-trier.de");
        createContact("Phillip", "Gleiche", "gleichep@hochschule-trier.de");
        createContact("Nikolaus", "G�bels", "goebelsn@hochschule-trier.de");
        createContact("Moritz", "Goertz", "goertzm@hochschule-trier.de");
        createContact("Philip", "Gorecki", "goreckip@hochschule-trier.de");
        createContact("Benjamin", "Gro�", "grossb@hochschule-trier.de");
        createContact("Maximilian", "Gro�", "grossmax@hochschule-trier.de");
        createContact("Fabian", "Grosch", "groschf@hochschule-trier.de");
        createContact("Florian", "Gro�mann", "grossmaf@hochschule-trier.de");
        ...
        createContact("Andr�", "Hannmann", "hannmana@hochschule-trier.de");
        ...
        createContact("Georgij", "Hergenr�der", "hergenrg@hochschule-trier.de");
        createContact("Andreas", "Hergert", "hergerta@hochschule-trier.de");
        createContact("Johannes", "He�", "hessj@hochschule-trier.de");
        ...
        createContact("Christian", "H�lz", "hoelzc@hochschule-trier.de");
        ...
        createContact("�zkan", "Isik", "isiko@hochschule-trier.de");
        createContact("Maximilian", "Jacobs", "jacobsma@hochschule-trier.de");
        createContact("Tomas", "J�hner", "jaehnert@hochschule-trier.de");
        createContact("Jerome", "J�hnig", "jaehnigj@hochschule-trier.de");
        createContact("Karolina", "John", "johnk@hochschule-trier.de");
        createContact("Lucas", "Junglen", "junglenl@hochschule-trier.de");
        createContact("Thomas", "J�rgensen", "juergent@hochschule-trier.de");
        ...
        createContact("Kevin", "K�chler", "kuechlek@hochschule-trier.de");
        ...
        createContact("Erik", "Lautenschl�ger", "lautense@hochschule-trier.de");
        ...
        createContact("Max Gabriel", "L�he", "loehem@hochschule-trier.de");
        ...
        createContact("Kevin", "Me�mer", "messmerk@hochschule-trier.de");
        ...
        createContact("Bj�rn", "M�bes", "moebesb@hochschule-trier.de");
        createContact("Jonas", "M�ller", "muellejo@hochschule-trier.de");
        ...
        createContact("Sarah", "Sch�ler", "schoeles@hochschule-trier.de");
        ...
        createContact("Jo�", "Steffen", "steffej@hochschule-trier.de");
        ...
        createContact("Angelika", "Thom�", "thomaea@hochschule-trier.de");
        createContact("Jens Guan Su", "Tien", "tienj@hochschule-trier.de");
        createContact("Pascal", "Vilfan", "vilfanpa@hochschule-trier.de");
        createContact("Marie", "von G��ler", "vongaesm@hochschule-trier.de");
